...
import 'package:bloc_cubit/cubit/countercubit_cubit.dart';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  RaisedButton(
                    onPressed: () {
                      context.bloc<CounterBloc>().add(CounterBlocIncrement(1));
                    },
                    child: Text(
                      "+",
                      style: GoogleFonts.poppins(
              ...
              child: Column(
                ...
                children: [
                  ...
                  BlocBuilder<CountercubitCubit, CountercubitState>(
                    ...
                    Text(
                      (cubitState is CountercubitStateFilled) ? "${cubitState.value}" : "-",
                      style: GoogleFonts.poppins(
                        fontSize: 35,
                        fontWeight: FontWeight.w600,
                      ),
